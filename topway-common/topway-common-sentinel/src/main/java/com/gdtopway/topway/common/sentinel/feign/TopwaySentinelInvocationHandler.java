 ...
 */
@Slf4j
public class TopwaySentinelInvocationHandler implements InvocationHandler {
	...
	TopwaySentinelInvocationHandler(Target<?> target, Map<Method, InvocationHandlerFactory.MethodHandler> dispatch,
	...
	public boolean equals(Object obj) {
		if (obj instanceof SentinelInvocationHandler) {
			TopwaySentinelInvocationHandler other = (TopwaySentinelInvocationHandler) obj;
