...
import com.gdtopway.topway.common.xss.utils.XssUtil;
...
public class DefaultXssCleaner implements XssCleaner {
	...
	private final TopwayXssProperties properties;
	...
	public String clean(String bodyHtml) {
		...
		TopwayXssProperties.Mode mode = properties.getMode();
		if (TopwayXssProperties.Mode.escape == mode) {
			// html 转义
