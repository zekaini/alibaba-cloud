package com.gdtopway.topway.common.job;

import com.gdtopway.topway.common.job.properties.XxlExecutorProperties;
import com.gdtopway.topway.common.job.properties.XxlJobProperties;
...
public class XxlJobAutoConfiguration {
	...
	public XxlJobSpringExecutor xxlJobSpringExecutor(XxlJobProperties xxlJobProperties, Environment environment,
		...
		// 如果配置为空则获取注册中心的服务列表 "http://topway-xxl:9080/xxl-job-admin"
