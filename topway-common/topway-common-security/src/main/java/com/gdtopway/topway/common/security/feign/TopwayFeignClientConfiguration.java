...
package com.gdtopway.topway.common.security.feign;

import feign.RequestInterceptor;
import org.springframework.context.annotation.Bean;
import org.springframework.security.oauth2.server.resource.web.BearerTokenResolver;

public class TopwayFeignClientConfiguration {
	...
	public RequestInterceptor oauthRequestInterceptor(BearerTokenResolver tokenResolver) {
		return new TopwayOAuthRequestInterceptor(tokenResolver);
	}

	@Bean
	public RequestInterceptor clientToCRequestInterceptor() {
		return new TopwayClientToCRequestInterceptor();
	}
