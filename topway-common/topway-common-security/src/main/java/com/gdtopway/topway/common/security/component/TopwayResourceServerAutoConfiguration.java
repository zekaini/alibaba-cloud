...
public class TopwayResourceServerAutoConfiguration {
	 ...
	 */
	@Bean
	public TopwayBearerTokenExtractor pigBearerTokenExtractor(PermitAllUrlProperties urlProperties) {
		return new TopwayBearerTokenExtractor(urlProperties);
	}
	...
	public OpaqueTokenIntrospector opaqueTokenIntrospector(OAuth2AuthorizationService authorizationService) {
		return new TopwayCustomOpaqueTokenIntrospector(authorizationService);
	}
