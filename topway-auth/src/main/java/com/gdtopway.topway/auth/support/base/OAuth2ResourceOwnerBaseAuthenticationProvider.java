package com.gdtopway.topway.auth.support.base;

import cn.hutool.core.util.BooleanUtil;
import cn.hutool.extra.spring.SpringUtil;
import com.gdtopway.topway.common.core.constant.CommonConstants;
import com.gdtopway.topway.common.security.service.TopwayRedisOAuth2AuthorizationService;
import com.gdtopway.topway.common.security.util.OAuth2ErrorCodesExpand;
import com.gdtopway.topway.common.security.util.ScopeException;
...
public abstract class OAuth2ResourceOwnerBaseAuthenticationProvider<T extends OAuth2ResourceOwnerBaseAuthenticationToken>
	...
	public Authentication authenticate(Authentication authentication) throws AuthenticationException {
		...
		try {
			...
			TopwayRedisOAuth2AuthorizationService redisOAuth2AuthorizationService = (TopwayRedisOAuth2AuthorizationService) this.authorizationService;
