 ...
 * @date 2022-06-04
 */
public class TopwayDaoAuthenticationProvider extends AbstractUserDetailsAuthenticationProvider {
	...
	public TopwayDaoAuthenticationProvider() {
	...
	protected final UserDetails retrieveUser(String username, UsernamePasswordAuthenticationToken authentication) {
		...
		Map<String, TopwayUserDetailsService> userDetailsServiceMap = SpringUtil
