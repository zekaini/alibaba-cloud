...
package com.gdtopway.topway.auth.endpoint;
...
import com.gdtopway.topway.admin.api.feign.RemoteClientDetailsService;
import com.gdtopway.topway.admin.api.feign.RemoteTenantService;
import com.gdtopway.topway.admin.api.vo.TokenVo;
...
import com.gdtopway.topway.common.security.util.OAuth2ErrorCodesExpand;
import com.gdtopway.topway.common.security.util.OAuthClientException;
...
public class TopwayTokenEndpoint {

	private final TopwayAuthenticationFailureEventHandler authenticationFailureHandler;
	...
	public R<Page<TokenVo>> tokenList(@RequestBody Map<String, Object> params) {
		...
		List<TokenVo> tokenVoList = redisTemplate.opsForValue().multiGet(pages).stream().map(obj -> {
			...
			TopwayUser pigxUser = (TopwayUser) authentication.getPrincipal();
